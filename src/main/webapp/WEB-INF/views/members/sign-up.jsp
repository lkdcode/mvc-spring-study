    ...
    <script>
        ...
        $idInput.onkeyup = e => {
            ...
            if (idValue.trim() === '') {
                ...
                $idInput.style.borderColor = 'red';
                document.getElementById('idChk').innerHTML
                = '<b style="color: red;">[공백은 포함할 수 없습니다!]</b>';
                checkResultList[0] = false;
            } else if (!accountPattern.test(idValue)) {
                $idInput.style.borderColor = 'red';
                document.getElementById('idChk').innerHTML
                = '<b style="color: red;">[아이디는 4~14글자의 영문,숫자만 가능합니다!]</b>';
                checkResultList[0] = false;
            } else {
                ...
                fetch('/members/check?type=account&keyword='+idValue)
                    ...
                    .then(flag => {
                        if(flag) {
                            ...
                            $idInput.style.borderColor = 'red';
                            document.getElementById('idChk').innerHTML
                            = '<b style="color: red;">[중복된 아이디 입니다!!]</b>';
                            checkResultList[0] = false;
                        } else {
        ...
        document.getElementById('signup-btn').onclick = e => {
            // 5개의 입력칸이 입력칸이 모두 통과(true)되었을 경우 폼을 submit
        ...
        $fileInput.onchange = e => {
            ...
            // 파일의 바이트 데이터를 읽어서 img 태그의 src 속성이나
            // a태그의 href 속성에 넣기 위한 형태로 읽음
